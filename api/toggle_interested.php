...
if (!isset($_SESSION['user_id'])) {
    echo json_encode(array("success"=>false,"is_logged-in"=>false));
    return;
}
$user_id=$_SESSION['user_id'];
$property_id=$_GET["property_id"];

$sql_1="SELECT * FROM interested_users_properties WHERE property_id= $property_id AND user_id=$user_id";
...
if (mysqli_num_rows($result_1)>0) {
   $sql_2="DELETE FROM interested_users_properties WHERE property_id= $property_id AND user_id=$user_id";
