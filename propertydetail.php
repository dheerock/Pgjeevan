...
$sql_3 = "SELECT a.* FROM ammenities a INNER JOIN properties_ammenities pa ON a.id=pa.amenity_id WHERE pa.property_id=$property_id";
...
$ammenities = mysqli_fetch_all($result_3, MYSQLI_ASSOC);
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            ...
            <li class="breadcrumb-item">
                <a href="propertylist.php?city=<?= $property['city_name']; ?>"><?= $property['city_name']; ?></a>
            </li>
    ...
    <div class="property-summary page-container">
        <div class="row no-gutters justify-content-between">
            ...
            ?>
            <div class="star-container col-md-auto" title="=<?= $total_rating ?>">
                <?php
                $rating = $total_rating;
                for ($i = 0; $i < 4; $i++) {
                    if ($rating >= $i + 0.8) {
            ...
            <div class="interested-container col-md-auto">
                <?php
                $is_interested = false;
